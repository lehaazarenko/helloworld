(function(){
  'use strict';
    ...
    angular.module('helloworld').controller('issuesSearchController', ['$state', '$stateParams', '$q', 'searchFactory',  function($state, $stateParams, $q, searchFactory) {

    const ctrl = this;

    console.log('factory: ',searchFactory);
    console.log('in issues controller');
